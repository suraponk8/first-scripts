...
User account found
      ...
      Wait Until Page Contains   บริษัท ซีโอแอล จำกัด (มหาชน)
      Close Browser
...
Used Command TS009 Notfound Data
      Open Browser  http://www.oic.officemate.int/Transport/TS009  chrome
      Wait Until Page Contains  Username
      Input Text    UserId  surapon@officemate.int
      Input Text    Password  Zxcv1234!
...
Used Command SO015
      Open Browser  http://www.oic.officemate.int/SaleOrder/SO015  chrome
      Wait Until Page Contains  Username
      Input Text    UserId  surapon@officemate.int
      Input Text    Password  Zxcv1234!
      Click Button  Sign In
      Go To  http://www.oic.officemate.int/SaleOrder/SO015
      Wait Until Page Contains  ค้นหา SO ที่มีการ Transfer Order (SO015)
      Select Radio Button  SO015Search.IsCheck  SoNo
      Input Text   SO015Search_SoNo  SO1805020447
      Click Button  Search
      Wait Until Page Contains   ทั้งหมด 1 รายการ
      Select Radio Button  SO015Search.IsCheck  SoDate
      Input Text   SO015Search_SearchDateFrom  02/05/2018
      Input Text   SO015Search_SearchDateTo  02/05/2018
      Wait Until Page Contains  SO1805020447
      Close Browser



#Used Command IR009 Get Type IsThaiPost
#      Open Browser  http://www.oic.officemate.int/InventoryReport/IR009  chrome
#      Wait Until Page Contains  Username
#      Input Text    UserId  surapon@officemate.int
#      Input Text    Password  Zxcv1234!
#      Click Button  Sign In
#      Go To  http://www.oic.officemate.int/InventoryReport/IR009
...
Used Command IR009 Get Type All
      Open Browser  http://www.oic.officemate.int/InventoryReport/IR009  chrome
      Wait Until Page Contains  Username
      Input Text    UserId  surapon@officemate.int
      Input Text    Password  Zxcv1234!
      ...
      Go To  http://www.oic.officemate.int/InventoryReport/IR009
      Wait Until Page Contains  รายงานสรุปยอดรวม SO แพ็คผ่านขนส่ง (IR009)
      Input Text    FromInv  03/05/2018
      Input Text    ToInv  03/05/2018
      Click Button  Search
      Wait Until Page Contains  Zone ID
      Close Browser
...
Used Command CC001 search by delivery date and display reptsaleId
      Open Browser  http://www.oic.officemate.int/CRCOnlineReport/CC001  chrome
      Wait Until Page Contains  Username
      Input Text    UserId  surapon@officemate.int
      Input Text    Password  Zxcv1234!
      Click Button  Sign In
      Go To  http://www.oic.officemate.int/CRCOnlineReport/CC001
...
Used Command IR025 Display columns [SoRemark ,Remark ,ShippingRemark,ConfirmTruck]
      Open Browser  http://www.oic.officemate.int/InventoryReport/IR025  chrome
      Wait Until Page Contains  Username
      Input Text    UserId  surapon@officemate.int
      Input Text    Password  Zxcv1234!
      Click Button  Sign In
      Go To  http://www.oic.officemate.int/InventoryReport/IR025
...
#      Input Text    Password  Zxcv1234!
#      Click Button  Sign In
#      Go To  http://www.oic.officemate.int/Product/P001
...
Used Command P001 display
      ...
      Input Text    searchKey     0000116
      Click Button  Search
      Wait Until Page Contains  รหัสสินค้า OFM
      Close Browser
...
Used Command SIO29 Search Data
      ...
      Input Text    Password  Zxcv1234!
      Click Button  Sign In
      Go To  http://www.oic.officemate.int/Invoice/SI029
...
Used Command SI010 search by invoice date and dellivery by Thai post
      ...
      Input Text    Password  Zxcv1234!
      Click Button  Sign In
      Go To  http://www.oic.officemate.int/Product/SI010
...
Used Command SO001 search data
      ...
      Input Text    Password  Zxcv1234!
      Click Button  Sign In
      Go To  http://www.oic.officemate.int/SaleOrder/SO001
...
Used Command C006 search data
      ...
      Input Text    Password  Zxcv1234!
      Click Button  Sign In
      Go To  http://www.oic.officemate.int/MonthlySummary/C006
...
Used Command SI001 search data
      Open Browser  http://www.oic.officemate.int  chrome
      Wait Until Page Contains  Username
      Input Text    UserId  surapon@officemate.int
      Input Text    Password  Zxcv1234!
      Click Button  Sign In
      Go To  http://www.oic.officemate.int/Invoice/SI001
      Wait Until Page Contains  ค้นหาข้อมูล Invoices (SI001)
      Input Text    invText   SI1711063405
      Click Button  Search
      Wait Until Page Contains    เลขที่ Inv
      Close Browser
